  ...
  return (
    ...
    >
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-[540px] mx-4 bg-bg-overlay border border-border rounded-[var(--radius-xl)] shadow-float overflow-hidden animate-[scaleIn_0.15s_ease]"
      ...
      >
        ...
        {/* Results */}
        <div className="max-h-[60vh] sm:max-h-[340px] overflow-y-auto py-1.5">
          {results.length === 0 ? (
            ...
            <>
              ...
              {results.map((page, idx) => (
                <button
                  ...
                  className={`
                    flex items-center gap-3 w-full px-4 py-2.5 text-left transition-theme
        ...
        {/* Footer hint */}
        <div className="flex items-center gap-4 px-5 py-2.5 border-t border-separator text-[11px] text-text-muted">
          <span>↑↓ Navigate</span>
          <span>↵ Open</span>
          <span>Esc Close</span>
        </div>
